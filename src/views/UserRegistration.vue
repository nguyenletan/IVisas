        ...
        <div class="row">
          <div class="centerx labelx col-8">
            <vs-input
              ...
              v-model="walletName"
              danger-text="The wallet name is required"
            ...
            <vs-input
              ...
              v-model="walletKey"
              danger-text="The wallet key is required"
              :vs-danger="errors.has('wallet-key')"
              ref="wallet-key"
            />
            <vs-input
              name="wallet-key-confirm"
              v-validate="'required|confirmed:wallet-key'"
              type="password"
              label="Wallet Key Confirm"
              data-vv-as="wallet-key"
              placeholder="Wallet Key Confirm"
              v-model="walletKeyConfirm"
            ...
            <p class="description">
              By clicking "Sign Up" I agree that I have accepted
              <a href="#">Term of Use</a>
            </p>
          </div>
          <div class="col-3 text-right">
            <img
              class="user-registration-background"
              src="@/assets/images/user-registration-background.png"
            />
          </div>
        </div>
        <div class="row mt-4">
