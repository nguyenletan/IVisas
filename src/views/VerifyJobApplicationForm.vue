    ...
    <div class="container container-border">
      <form class="" @submit="submit">
          ...
          <div class="col-lg-10 col-xl-9  m-auto">
            <h2>
              Personal information &nbsp;<span
                class="personal-information-description"
                >(issued by Department of Residence Registration)</span
              >
            </h2>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10 col-xl-9 m-auto">
            <h2>
              Education &nbsp;<span class="education-description"
                >(issued by ABC University)</span
              >
            </h2>
          </div>
        </div>
